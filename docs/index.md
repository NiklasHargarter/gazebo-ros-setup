...
By default, the environment uses **ROS 2 Jazzy**. You can easily switch to other versions like **Jazzy** by setting the `ROS_DISTRO` environment variable:
...
### Humble Gazebo naming

when using humble `gz` is named `ign`
